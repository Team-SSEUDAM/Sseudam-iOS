...
@Reducer
public struct SuggestionFeature {
  ...
  public struct State: Equatable {
    ...
    var child: SuggestionChildFeature.State = SuggestionChildFeature.State()
...
public extension SuggestionFeature {
...
extension SuggestionFeature {
  @Reducer(state: .equatable, action: .equatable)
  public enum Destination {
    case alert(AlertState<SuggestionFeature.Action.Alert>)
  }
}


extension AlertState where Action == SuggestionFeature.Action.Alert {
